...
export function DialogSkill() {
    ...
    const {
        ...
        mode: "onSubmit",          // ✅ valida só no submit
        reValidateMode: "onSubmit" // ✅ não revalida enquanto digita
    });
                    ...
                    <div className="w-full">
                        <Controller
                            ...
                            render={({ field }) => (
                                ...
                                >
                                    <SelectTrigger className="w-full h-12! bg-white! text-black placeholder:text-gray-500">
                                        <SelectValue className="placeholder:text-gray-500" placeholder="Selecione o nível" />
                                    </SelectTrigger>
